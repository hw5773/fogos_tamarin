...
\usepackage{graphicx}
\usepackage{msc}
\usepackage{amsfonts, amsmath, mathtools, amssymb, amsthm}
\usepackage{array}
\usepackage{makecell}
...
\newcommand{\encryptWith}[2]{\ensuremath{%
  \{%
    #1%
  \}_{#2}%
  }}
...
% resizebox creates a parbox with variable width depending on the length
% of the content. It looks very impressive, but I stole it from stackexchange
\newlength{\minwidth}
\newcommand{\rezizebox}[1]{
